...
public class PivotSubsystem extends SubsystemBase {
  ...
  private static SparkMax sparkMax13 =
      new SparkMax(PivotConstants.PivotCanID, MotorType.kBrushless);
